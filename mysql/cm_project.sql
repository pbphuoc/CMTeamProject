...
CREATE TABLE `order` (
  ...
  `receive_method` enum('PICKUP','DELIVERY') NOT NULL,
  `payment_type` enum('CARD','TRANSFER','ATSTORE') NOT NULL DEFAULT 'TRANSFER',
  `payment_date` date DEFAULT NULL,
  `status` enum('PENDING','RECEIVED','PROCESSED','READY','FINISHED') NOT NULL DEFAULT 'PENDING',
...
-- Dump completed on 2023-01-10  2:39:47
